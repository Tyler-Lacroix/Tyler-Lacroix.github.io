...
void SceneManager::LoadSceneTextures()
{
	...
	***/
	...
	/*bReturn = CreateGLTexture(
		"rubix.jpg",
		"rubix");*/ //unused texture from old build
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.99f, 0.8f, 0.7f);
	...
	//m_pShaderManager->setVec3Value("lightSources[1].position", -3.0f, 14.0f, 5.0f);
...
void SceneManager::RenderScene()
{
	...
	positionXYZ = glm::vec3(0.0f, -1.0f, -17.0f);
	...
	//far left shelf
			...
			// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 5.0f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-19.0f, 8.75f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-11.0f, 8.75f, -15.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(8.0f, 5.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-15.0f, 8.0f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.5f, 3.75f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.0f, 3.75f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.0f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(15.0f, -2.0f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, -1.25f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(19.0f, -1.25f, -15.0f);
	...
	YrotationDegrees = 87.0f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 8.5f, -15.0f);
	...
	//SetShaderColor(0.4, 0.5, 0.7, 1);
	SetShaderTexture("fabreze");
	SetShaderMaterial("cement");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.0f, 13.5f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-17.5f, 15.5f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-18.0f, 14.5f, -15.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.5f, 4.5f, -15.0f);
	...
	*/ //unused in current build
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.0f, 4.0f, -15.0f);
	...
	//posters
		// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 0.0f, 5.5f);
	...
	//FF7R Box Art
		// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.0f, 0.0f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.5f, 6.0f, -16.5f);
	...
	//switch games
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(3.5f, 0.0f, 2.5f);
